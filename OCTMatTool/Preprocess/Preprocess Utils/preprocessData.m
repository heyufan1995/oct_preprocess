function [img_vol,retina_mask,bds,shifts] = preprocessData(img_vol,header,pp_params,scanner_type,fids,seg_pts)
...
try
    if pp_params.fast_rpe
        ...
        if strcmp(scanner_type,'spectralis')
            [retina_mask, shifts, bds, nbpt] = retinaDetector(img_vol,header,pp_params.retinadetector_type,false); 
        else
